(() => {
  ...
  (() => {
        ...
        if (C) {
          if (r) {
            var $,
              ...
              le = N + te - oe,
              ce = xe(h ? S(H, N + ee - oe - ae) : H, N, h ? w(W, le) : W);
            (C[x] = ce), (k[x] = ce - N);
          }
          if (o) {
            var de,
              ...
              we = ve ? he + T[fe] + O[fe] - be - L.altAxis : ge,
              Ee =
                h && ve
                  ? (function (e, t, s) {
                      var n = xe(e, t, s);
    ...
    function bt(e, t) {
      ...
      function j() {
        ...
        e.addEventListener("mousedown", V, !0),
          ...
          e.addEventListener("touchmove", q, $e);
      }
      function z() {
        var e = P();
        e.removeEventListener("mousedown", V, !0),
          ...
          e.removeEventListener("touchmove", q, $e);
      }
      function H(e, t) {
        var s = k().box;
        function n(e) {
    ...
    setTimeout(() => {
      ...
      (Ls.prototype.mediaHandler = function (e, t) {
        if (e.matches)
      ...
      (Ls.prototype.moveTo = function (e, t, s) {
      ...
      (Ls.prototype.moveBack = function (e, t, s) {
        t.classList.remove(this.daClassname),
          void 0 !== e.children[s]
            ? e.children[s].insertAdjacentElement("beforebegin", t)
            : e.insertAdjacentElement("beforeend", t);
      }),
      (Ls.prototype.indexInParent = function (e, t) {
        const s = Array.prototype.slice.call(e.children);
        return Array.prototype.indexOf.call(s, t);
      }),
      (Ls.prototype.arraySort = function (e) {
        "min" === this.type
    ...
    const Ps = document.querySelectorAll(".sub-menu-catalog__block");
    Ps.length &&
      Ps.forEach((e) => {
